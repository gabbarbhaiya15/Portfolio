  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>Yash Raj Bhardwaj</h2>
        <p className='i_am_a'>I am a&nbsp;<span class="typewriter"></span></p>
        
        <div className="flex1">
        <p className='follow_me'>Contact Me: </p>
        <div className="logos">
        
        <a href="https://github.com/gabbarbhaiya15" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="www.linkedin.com/in/yash-raj-bhardwaj-72a79825a" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
       
        </div>
        </div>
        <div className="flex1">
        <a href="https://mail.google.com/mail/u/1/?view=cm&fs=1&to=keniyashraj@gmail.com&tf=1"><button className='buttonc'>E-Mail Me</button></a>
        <button onClick={() => window.open("https://drive.google.com/file/d/1j59SsWygPMJUDjg2rdQ0dOQDHKJ3O93R/view?usp=sharing", "_blank")} className='buttonb'>Resume</button>
        </div>
      </div>
      <div className="right_main">
     <div className="behind_the_image">
